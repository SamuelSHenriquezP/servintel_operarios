        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDynamicSection('Detalles del Equipo', _equipos, _addEquipo, (i) => [
                TextFormField(controller: _equipos[i]['equipoMarca'], decoration: const InputDecoration(labelText: 'Equipo / Marca')),
                const SizedBox(height: 12),
                Row(children: [
              ...
              _buildDynamicSection('Trabajo Realizado', _detalles, _addDetalle, (i) => [
                TextFormField(controller: _detalles[i]['diagnostico'], decoration: const InputDecoration(labelText: 'Diagnóstico')),
                const SizedBox(height: 12),
      ...
      children: [
        ...
        for (int i = 0; i < items.length; i++) ...[
          PremiumCard(
            ...
            child: Column(children: builder(i)),
          ),
        ],
      ],
    );
